      ...
      <div className="w-full px-5 sm:px-10 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 max-w-[1600px] mx-auto overflow-hidden">
        <div className=" max-w-3xl mx-auto ">
          ...
          {isFaqSectionOpen && (
            <>
              <div
                className="absolute left-0 top-[200px] sm:top-[300px] md:top-[380px] hidden sm:block z-0 transition-opacity duration-500 ease-in-out opacity-0 animate-fadeIn"
              ...
              <div
                className="absolute right-0 rotate-180 hidden sm:block z-0 transition-opacity duration-500 ease-in-out opacity-0 animate-fadeIn"
                style={{
          ...
          <div className="text-center mb-6 sm:mb-8 md:mb-12 lg:mb-16">
            ...
            > */}
              <div className="flex items-center justify-center gap-3 mb-2 sm:mb-3 md:mb-4">
                <h2
                  data-aos="fade-down"
                  className="dm-serif-display text-3xl lg:text-4xl font-medium text-[#5A4685]"
                >
                  FAQ's
                </h2>
                {/* <div
              ...
              <p
                data-aos="fade-down"
                className="dm-serif-display text-[#0B0B19] text-base  md:text-base lg:text-[21px] max-w-2xl mx-auto leading-relaxed"
              >
                ...
                >
                  ...
                  >
                    <div className="flex items-start sm:items-center justify-between gap-2 sm:gap-3">
                      <h3
                        className={`dm-serif-display text-sm md:text-base lg:text-lg font-medium leading-tight sm:leading-relaxed flex-1 ${
                          activeIndex === index
                            ? "text-[#5A4685]"
                            : "text-gray-900"
                        }`}
