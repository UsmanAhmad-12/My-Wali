            ...
            <div className='w-full py-20 sm:py-40 md:py-24  relative overflow-hidden'>
                ...
                <div className='relative z-20'>
                    <div className='flex flex-col justify-center items-center'>
                        <img data-aos="fade-up" className='w-[260px] h-[240px]' src={logoMasjidHero} alt="" />
                        <p data-aos="fade-up" className='mt-8 w-[90%] md:w-[80%] lg:w-[83%] 2xl:w-[58%] tracking-wide text-xl  md:text-2xl montserrat text-center  text-white'>Empowering masjids to support the matchmaking journey within their communities. <span className='font-bold'>Strengthening the community through faith, family, and marriage.</span>
                        </p>
