...
const Faq = () => {
    ...
    return (
        <div className='w-full bg-[#fafafa] px-5 sm:px-10 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 relative overflow-hidden'>
            ...
            >
                <div className={`space-y-0 transition-all duration-500 ease-in-out ${
                    ...
                    {faqData.map((faq, index) => (
                        <div key={index} className={`border-b border-gray-200 transition-all duration-300 ease-in-out ${
                            isFaqSectionOpen 
                                ? 'opacity-100 translate-y-0' 
                                : 'opacity-0 translate-y-1'
                        }`} style={{ transitionDelay: isFaqSectionOpen ? `${index * 50}ms` : '0ms' }}>
                            <button
                            ...
                            {/* Answer Content */}
                            <div className={`overflow-hidden transition-all duration-400 ease-in-out transform ${
                                activeIndex === index 
                                    ? 'max-h-[500px] sm:max-h-[400px] md:max-h-[350px] opacity-100 translate-y-0' 
                                    : 'max-h-0 opacity-0 -translate-y-2'
                            }`}>
                                <div className={`pb-1 sm:pb-2 md:pb-3 transition-all duration-300 ease-in-out ${
                                    activeIndex === index 
                                        ? 'opacity-100 translate-y-0' 
                                        : 'opacity-0 translate-y-1'
                                }`}>
