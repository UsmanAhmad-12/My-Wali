...
function WhyMyWali() {
  return (
    <div className="bg-[#f4f1fa] mx-auto">
      <div className="md:py-32 py-12">
        <h1 data-aos="fade-up" className="mx-auto text-center px-5 md:px-0 text-[32px] md:text-[42px] md:w-[50%] dm-serif-display leading-[45px] font-medium"><span className="text-[#5A4685] dm-serif-display">MyWali</span>— Born from real struggles, built for the ummah</h1>
        <p data-aos="fade-right" className="montserrat  tracking-tight  text-[13px] mx-auto lg:text-[18px] text-center leading-[25px] px-5 md:px-0 md:w-[65%] mt-12 text-[#403F3D] font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-6 md:gap-4 mt-10 justify-center items-center">
          ...
          <a data-aos="fade-left"
            href="#"
            className="flex items-center bg-black text-white px-4 md:px-5 py-2 rounded-lg border-2 border-white hover:bg-gray-800 transition-colors duration-200"
          >
