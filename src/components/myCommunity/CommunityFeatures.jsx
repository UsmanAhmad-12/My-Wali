  ...
  return (
    ...
    <div className="flex lg:flex-row flex-col px-5 md:px-20 lg:px-10 xl:px-28 py-12 md:py-24 max-w-[1600px] mx-auto overflow-hidden  "> 
      <div className="w-full lg:w-[90%] ">
        ...
        <p data-aos="fade-right" className="montserrat tracking-tight text-[16px] mx-auto md:mx-0 lg:text-[21px] text-justify leading-[25px] w-[90%] mt-6 text-[#403F3D] font-bold pt-2 sm:pt-0">
